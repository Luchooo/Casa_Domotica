...
var Persona = function () {
    ...
    _createClass(Persona, [{
        ...
        value: function getPersona() {
            return [this.guid, "<img src = '" + this.foto + "' class = 'ftabla'>", this.identificacion, this.primernombre + " " + this.primerapellido, this.email, this.fechanacimiento];
        }
    }]);
...
},{"./persistencia":5,"./utils":7}],3:[function(require,module,exports){
"use strict";
...
var config = {
                ...
                schema: {
                                nombre: "usuarios",
                                registros: ["guid", "identificacion", "primernombre", "primerapellido", "email", "fechanacimiento", "foto"]
                }
};
                ...
                if (_utils2.default.ValidaEmail(nuevaPersona.email)) {
                    ...
                    if (guidEdita === "") {
                        personas.adicionaPersona(new _Persona2.default.Persona(nuevaPersona), function (error) {
                            ...
                            swal({
                                title: "Guardado!",
                                text: "A la espera de aprobacion del administrador de la casa! Revise su correo",
                                type: "success",
                                ...
                                setTimeout(function () {
                                    ...
                                    swal({
                                        ...
                                        if (isConfirm) {
                                            ...
                                            window.location.replace("https://login.live.com/login.srf?wa=wsignin1.0&rpsnv=12&ct=1462313819&rver=6.4.6456.0&wp=MBI_SSL_SHARED&wreply=https:%2F%2Fmail.live.com%2Fdefault.aspx%3Frru%3Dinbox&lc=3082&id=64855&mkt=es-es&cbcxt=mai");
                                        } else {
                                            swal("Cancelar", " :)", "error");
                                        }
                                    });
...
(0, _persistencia.getData)(function (data) {
    ...
    imprimeUsuarios();
    _photo2.default.configurePhoto();
});

_utils2.default.nom_div("fperfil").addEventListener('click', function (event) {
    photoUser = _photo2.default.takePhoto();
    _utils2.default.nom_div("fperfil").src = photoUser;
...
},{"./Persona":1,"./Personas":2,"./persistencia":5,"./photo":6,"./utils":7}],5:[function(require,module,exports){
"use strict";
...
var opcFoto = {
    ejecuta: false,
    reproduce: false,
    video: (0, _utils.nom_div)("video"),
    canvas: (0, _utils.nom_div)("canvas"),
    width: 200,
    height: 150
};

var configurePhoto = function configurePhoto() {
